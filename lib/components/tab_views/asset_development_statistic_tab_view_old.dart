...
class AssetDevelopmentStatisticTabViewOld extends StatefulWidget {
  const AssetDevelopmentStatisticTabViewOld({Key? key}) : super(key: key);

  @override
  State<AssetDevelopmentStatisticTabViewOld> createState() => _AssetDevelopmentStatisticTabViewOldState();

  static _AssetDevelopmentStatisticTabViewOldState? of(BuildContext context) => context.findAncestorStateOfType<_AssetDevelopmentStatisticTabViewOldState>();
}

// TODO hier weitermachen und vergangene Vermögensentwicklung implementieren (SegmentedButton für Zeitraum Auswahl?)
class _AssetDevelopmentStatisticTabViewOldState extends State<AssetDevelopmentStatisticTabViewOld> {
